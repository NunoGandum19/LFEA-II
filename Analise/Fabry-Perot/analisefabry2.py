...
popt41_1, _ = curve_fit(gauss, valores_selecionados_1, T_Foto41[(T_Piezo41 >= 0) & (T_Piezo41 <= 2)], p0=p041_1)

p041_2 = [T_Foto41.max(), mean41_2, std_dev41_2, 5]  # Estimativas iniciais para A, mu e sigma
popt41_2, _ = curve_fit(gauss, valores_selecionados_2, T_Foto41[(T_Piezo41 >= 4) & (T_Piezo41 <= 5.5)], p0=p041_2)

p041_3 = [T_Foto41.max(), mean41_3, std_dev41_3, 5]  # Estimativas iniciais para A, mu e sigma
popt41_3, _ = curve_fit(gauss, valores_selecionados_3, T_Foto41[(T_Piezo41 >= 7.5) & (T_Piezo41 <= 9)], p0=p041_3)
...
plt.plot(x_fit41_1, gauss(x_fit41_1, *popt41_1), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt41_1[0], popt41_1[1],popt41_1[2], popt41_1[3]))
plt.plot(x_fit41_2, gauss(x_fit41_2, *popt41_2), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt41_2[0], popt41_2[1],popt41_1[2], popt41_2[3]))
plt.plot(x_fit41_3, gauss(x_fit41_3, *popt41_3), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt41_3[0], popt41_3[1],popt41_3[2], popt41_3[3]))
...
popt49_1, _ = curve_fit(gauss, valores_selecionados_1, T_Foto49[(T_Piezo49 >= 0.5) & (T_Piezo49 <= 3)], p0=p049_1)

p049_2 = [T_Foto49.max(), mean49_2, std_dev49_2, 5]  # Estimativas iniciais para A, mu e sigma
popt49_2, _ = curve_fit(gauss, valores_selecionados_2, T_Foto49[(T_Piezo49 >= 4) & (T_Piezo49 <= 6)], p0=p049_2)

p049_3 = [T_Foto49.max(), mean49_3, std_dev49_3, 5]  # Estimativas iniciais para A, mu e sigma
popt49_3, _ = curve_fit(gauss, valores_selecionados_3, T_Foto49[(T_Piezo49 >= 7.5) & (T_Piezo49 <= 10)], p0=p049_3)
...
plt.plot(x_fit49_1, gauss(x_fit49_1, *popt49_1), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt49_1[0], popt49_1[1],popt49_1[2], popt49_1[3]))
plt.plot(x_fit49_2, gauss(x_fit49_2, *popt49_2), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt49_2[0], popt49_2[1],popt49_1[2], popt49_2[3]))
plt.plot(x_fit49_3, gauss(x_fit49_3, *popt49_3), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt49_3[0], popt49_3[1],popt49_3[2], popt49_3[3]))
...
popt410_1, _ = curve_fit(gauss, valores_selecionados_1, T_Foto410[(T_Piezo410 >= 0.5) & (T_Piezo410 <= 3)], p0=p0410_1)

p0410_2 = [T_Foto410.max(), mean410_2, std_dev410_2, 5]  # Estimativas iniciais para A, mu e sigma
popt410_2, _ = curve_fit(gauss, valores_selecionados_2, T_Foto410[(T_Piezo410 >= 4) & (T_Piezo410 <= 6.5)], p0=p0410_2)

p0410_3 = [T_Foto410.max(), mean410_3, std_dev410_3, 5]  # Estimativas iniciais para A, mu e sigma
popt410_3, _ = curve_fit(gauss, valores_selecionados_3, T_Foto410[(T_Piezo410 >= 7.5) & (T_Piezo410 <= 10)], p0=p0410_3)
...
plt.plot(x_fit410_1, gauss(x_fit410_1, *popt410_1), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt410_1[0], popt410_1[1],popt410_1[2], popt410_1[3]))
plt.plot(x_fit410_2, gauss(x_fit410_2, *popt410_2), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt410_2[0], popt410_2[1],popt410_1[2], popt410_2[3]))
plt.plot(x_fit410_3, gauss(x_fit410_3, *popt410_3), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt410_3[0], popt410_3[1],popt410_3[2], popt410_3[3]))
...
popt411_1, _ = curve_fit(gauss, valores_selecionados_1, T_Foto411[(T_Piezo411 >= 0.5) & (T_Piezo411 <= 3)], p0=p0411_1)

p0411_2 = [T_Foto411.max(), mean411_2, std_dev411_2, 5]  # Estimativas iniciais para A, mu e sigma
popt411_2, _ = curve_fit(gauss, valores_selecionados_2, T_Foto411[(T_Piezo411 >= 4) & (T_Piezo411 <= 6.5)], p0=p0411_2)

p0411_3 = [T_Foto411.max(), mean411_3, std_dev411_3, 5]  # Estimativas iniciais para A, mu e sigma
popt411_3, _ = curve_fit(gauss, valores_selecionados_3, T_Foto411[(T_Piezo411 >= 7.5) & (T_Piezo411 <= 10)], p0=p0411_3)
...
plt.plot(x_fit411_1, gauss(x_fit411_1, *popt411_1), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt411_1[0], popt411_1[1],popt411_1[2], popt411_1[3]))
plt.plot(x_fit411_2, gauss(x_fit411_2, *popt411_2), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt411_2[0], popt411_2[1],popt411_1[2], popt411_2[3]))
plt.plot(x_fit411_3, gauss(x_fit411_3, *popt411_3), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt411_3[0], popt411_3[1],popt411_3[2], popt411_3[3]))
...
popt412_1, _ = curve_fit(gauss, valores_selecionados_1, T_Foto412[(T_Piezo412 >= 1.5) & (T_Piezo412 <= 3)], p0=p0412_1)

p0412_2 = [T_Foto412.max(), mean412_2, std_dev412_2, 5]  # Estimativas iniciais para A, mu e sigma
popt412_2, _ = curve_fit(gauss, valores_selecionados_2, T_Foto412[(T_Piezo412 >= 5) & (T_Piezo412 <= 6.5)], p0=p0412_2)

p0412_3 = [T_Foto412.max(), mean412_3, std_dev412_3, 5]  # Estimativas iniciais para A, mu e sigma
popt412_3, _ = curve_fit(gauss, valores_selecionados_3, T_Foto412[(T_Piezo412 >= 8.5) & (T_Piezo412 <= 10)], p0=p0412_3)
...
plt.plot(x_fit412_1, gauss(x_fit412_1, *popt412_1), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt412_1[0], popt412_1[1],popt412_1[2], popt412_1[3]))
plt.plot(x_fit412_2, gauss(x_fit412_2, *popt412_2), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt412_2[0], popt412_2[1],popt412_1[2], popt412_2[3]))
plt.plot(x_fit412_3, gauss(x_fit412_3, *popt412_3), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt412_3[0], popt412_3[1],popt412_3[2], popt412_3[3]))
...
popt42_1, _ = curve_fit(gauss_sum, T_Piezo42, T_Foto42, p0=p042_1)
...
popt42_2, _ = curve_fit(gauss_sum, T_Piezo42, T_Foto42, p0=p042_2)
...
popt42_3, _ = curve_fit(gauss_sum, T_Piezo42, T_Foto42, p0=p042_3)
...
plt.plot(x_fit42_1, gauss_sum(x_fit42_1, *popt42_1), label=r'$A1 = %.3f; \mu 1 = %.3f; \sigma 2 = %.3f; A2 = %.3f; \mu 2 = %.3f; \sigma 2  = %.3f; d = %.3f$' %(A1,mu1,sigma1,A2,mu2,sigma2,d))
plt.plot(x_fit42_2, gauss_sum(x_fit42_2, *popt42_2), label=r'$A3 = %.3f; \mu 3 = %.3f; \sigma 3 = %.3f; A4 = %.3f; \mu 4 = %.3f; \sigma 4 = %.3f; d = %.3f$' %(A3,mu3,sigma3,A4,mu4,sigma4,d))
plt.plot(x_fit42_3, gauss_sum(x_fit42_3, *popt42_3), label=r'$A5 = %.3f; \mu 5 = %.3f; \sigma 5 = %.3f; A6 = %.3f; \mu 6 = %.3f; \sigma 6 = %.3f; d = %.3f$' %(A5,mu5,sigma5,A6,mu6,sigma6,d))


#plt.plot(x_fit312_2, gauss(x_fit312_2, *popt312_2), label=r'$f(x) = %.3f \cdot \frac{1}{{%.3f \sqrt{2\pi}}} \cdot e^{-\frac{(x - %.3f)^2}{2%.3f^2}} + %.3f$' %(popt312_2[0], popt312_2[2], popt312_2[1],popt312_2[2], popt312_2[3]))
...
popt43_1, _ = curve_fit(gauss_sum, T_Piezo43, T_Foto43, p0=p043_1)
...
popt43_2, _ = curve_fit(gauss_sum, T_Piezo43, T_Foto43, p0=p043_2)
...
popt43_3, _ = curve_fit(gauss_sum, T_Piezo43, T_Foto43, p0=p043_3)
...
plt.plot(x_fit43_1, gauss_sum(x_fit43_1, *popt43_1), label=r'$A1 = %.3f; \mu 1 = %.3f; \sigma 2 = %.3f; A2 = %.3f; \mu 2 = %.3f; \sigma 2  = %.3f; d = %.3f$' %(A1,mu1,sigma1,A2,mu2,sigma2,d))
plt.plot(x_fit43_2, gauss_sum(x_fit43_2, *popt43_2), label=r'$A3 = %.3f; \mu 3 = %.3f; \sigma 3 = %.3f; A4 = %.3f; \mu 4 = %.3f; \sigma 4 = %.3f; d = %.3f$' %(A3,mu3,sigma3,A4,mu4,sigma4,d))
plt.plot(x_fit43_3, gauss_sum(x_fit43_3, *popt43_3), label=r'$A5 = %.3f; \mu 5 = %.3f; \sigma 5 = %.3f; A6 = %.3f; \mu 6 = %.3f; \sigma 6 = %.3f; d = %.3f$' %(A5,mu5,sigma5,A6,mu6,sigma6,d))
...
popt44_1, _ = curve_fit(gauss_sum, T_Piezo44, T_Foto44, p0=p044_1)
...
popt44_2, _ = curve_fit(gauss_sum, T_Piezo44, T_Foto44, p0=p044_2)
...
popt44_3, _ = curve_fit(gauss_sum, T_Piezo44, T_Foto44, p0=p044_3)
...
plt.plot(x_fit44_1, gauss_sum(x_fit44_1, *popt44_1), label=r'$A1 = %.3f; \mu 1 = %.3f; \sigma 2 = %.3f; A2 = %.3f; \mu 2 = %.3f; \sigma 2  = %.3f; d = %.3f$' %(A1,mu1,sigma1,A2,mu2,sigma2,d))
plt.plot(x_fit44_2, gauss_sum(x_fit44_2, *popt44_2), label=r'$A3 = %.3f; \mu 3 = %.3f; \sigma 3 = %.3f; A4 = %.3f; \mu 4 = %.3f; \sigma 4 = %.3f; d = %.3f$' %(A3,mu3,sigma3,A4,mu4,sigma4,d))
plt.plot(x_fit44_3, gauss_sum(x_fit44_3, *popt44_3), label=r'$A5 = %.3f; \mu 5 = %.3f; \sigma 5 = %.3f; A6 = %.3f; \mu 6 = %.3f; \sigma 6 = %.3f; d = %.3f$' %(A5,mu5,sigma5,A6,mu6,sigma6,d))
...
popt47_1, _ = curve_fit(gauss_sum, T_Piezo47, T_Foto47, p0=p047_1)
...
popt47_2, _ = curve_fit(gauss_sum, T_Piezo47, T_Foto47, p0=p047_2)
...
popt47_3, _ = curve_fit(gauss_sum, T_Piezo47, T_Foto47, p0=p047_3)
...
plt.plot(x_fit47_1, gauss_sum(x_fit47_1, *popt47_1), label=r'$A1 = %.3f; \mu 1 = %.3f; \sigma 2 = %.3f; A2 = %.3f; \mu 2 = %.3f; \sigma 2  = %.3f; d = %.3f$' %(A1,mu1,sigma1,A2,mu2,sigma2,d))
plt.plot(x_fit47_2, gauss_sum(x_fit47_2, *popt47_2), label=r'$A3 = %.3f; \mu 3 = %.3f; \sigma 3 = %.3f; A4 = %.3f; \mu 4 = %.3f; \sigma 4 = %.3f; d = %.3f$' %(A3,mu3,sigma3,A4,mu4,sigma4,d))
plt.plot(x_fit47_3, gauss_sum(x_fit47_3, *popt47_3), label=r'$A5 = %.3f; \mu 5 = %.3f; \sigma 5 = %.3f; A6 = %.3f; \mu 6 = %.3f; \sigma 6 = %.3f; d = %.3f$' %(A5,mu5,sigma5,A6,mu6,sigma6,d))
...
popt48_1, _ = curve_fit(gauss_sum, T_Piezo48, T_Foto48, p0=p048_1)
...
popt48_2, _ = curve_fit(gauss_sum, T_Piezo48, T_Foto48, p0=p048_2)
...
popt48_3, _ = curve_fit(gauss_sum, T_Piezo48, T_Foto48, p0=p048_3)
...
plt.plot(x_fit48_1, gauss_sum(x_fit48_1, *popt48_1), label=r'$A1 = %.3f; \mu 1 = %.3f; \sigma 2 = %.3f; A2 = %.3f; \mu 2 = %.3f; \sigma 2  = %.3f; d = %.3f$' %(A1,mu1,sigma1,A2,mu2,sigma2,d))
plt.plot(x_fit48_2, gauss_sum(x_fit48_2, *popt48_2), label=r'$A3 = %.3f; \mu 3 = %.3f; \sigma 3 = %.3f; A4 = %.3f; \mu 4 = %.3f; \sigma 4 = %.3f; d = %.3f$' %(A3,mu3,sigma3,A4,mu4,sigma4,d))
plt.plot(x_fit48_3, gauss_sum(x_fit48_3, *popt48_3), label=r'$A5 = %.3f; \mu 5 = %.3f; \sigma 5 = %.3f; A6 = %.3f; \mu 6 = %.3f; \sigma 6 = %.3f; d = %.3f$' %(A5,mu5,sigma5,A6,mu6,sigma6,d))
