...
x_fit34 = np.linspace(3, 4, 100)  # Intervalo para o ajuste

# Plotagem dos dados e da gaussiana ajustada
plt.figure(figsize=(12, 6))
plt.plot(T_Piezo34, T_Foto34, color='blue')

plt.plot(x_fit34, gauss(x_fit34, *popt34), color='red', label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt34[0], popt34[1],popt34[2], popt34[3]))
plt.xlabel('T.Piezo')
plt.ylabel('T.Foto')
plt.title('aula34')
...
plt.plot(x_fit35, gauss(x_fit35, *popt35), color='red', label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt35[0], popt35[1],popt35[2], popt35[3]))
plt.xlabel('T.Piezo')
plt.ylabel('T.Foto')
plt.title('aula35 ')
...
plt.plot(x_fit36, gauss_sum(x_fit36, *popt36_1), label=r'$A1 = %.3f; \mu 1 = %.3f; \sigma 1 = %.3f; A2 = %.3f; \mu 2 = %.3f; \sigma 2 = %.3f; d = %.3f$' %(A1,mu1,sigma1,A2,mu2,sigma2,d))
...
popt37_1, _ = curve_fit(gauss, valores_selecionados_1, T_Foto37[(T_Piezo37 >= 4) & (T_Piezo37 <= 5)], p0=p037_1)

p037_2 = [T_Foto37.max(), 5.7, 0.1, 5]  # Estimativas iniciais para A, mu e sigma
popt37_2, _ = curve_fit(gauss, valores_selecionados_2, T_Foto37[(T_Piezo37 >= 5) & (T_Piezo37 <= 6)], p0=p037_2)
...
plt.plot(x_fit37_1, gauss(x_fit37_1, *popt37_1), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt37_1[0], popt37_1[1],popt37_1[2], popt37_1[3]))
plt.plot(x_fit37_2, gauss(x_fit37_2, *popt37_2), label=r'$A = %.3f; \mu = %.3f; \sigma = %.3f; d = %.3f$' %(popt37_2[0], popt37_2[1],popt37_2[2], popt37_2[3]))
...
with open('aula3_8.lab', 'r') as file:
    lines = file.readlines()
...
popt38_1, _ = curve_fit(gauss_sum, T_Piezo38, T_Foto38, p0=p038)
...
plt.plot(x_fit38, gauss_sum(x_fit38, *popt38_1), label=r'$A1 = %.3f; \mu 1 = %.3f; \sigma 1 = %.3f; A2 = %.3f; \mu 2 = %.3f; \sigma 2 = %.3f; d = %.3f$' %(A1,mu1,sigma1,A2,mu2,sigma2,d))
...
with open('aula3_12.lab', 'r') as file:
    lines = file.readlines()
...
popt312_1, _ = curve_fit(gauss_sum, T_Piezo312, T_Foto312, p0=p0312)
x_fit312_1 = np.linspace(4, 7.5)  # Intervalo para o ajuste
A3 , mu3 , sigma3, A4, mu4, sigma4, d = popt312_1[0] , popt312_1[1], popt312_1[2] , popt312_1[3], popt312_1[4], popt312_1[5], popt312_1[6]
...
popt312_2, _ = curve_fit(gauss_sum, T_Piezo312, T_Foto312, p0=p0312_2)
x_fit312_2 = np.linspace(0, 1.8)  # Intervalo para o ajuste
A1 , mu1 , sigma1, A2, mu2, sigma2, d = popt312_2[0] , popt312_2[1], popt312_2[2] , popt312_2[3], popt312_2[4], popt312_2[5], popt312_2[6]
...
plt.plot(x_fit312_1, gauss_sum(x_fit312_1, *popt312_1), label=r'$A3 = %.3f; \mu 3 = %.3f; \sigma 3 = %.3f; A4= %.3f; \mu 4 = %.3f; \sigma 4 = %.3f; d = %.3f$' %(A3,mu3,sigma3,A4,mu4,sigma4,d))
plt.plot(x_fit312_2, gauss_sum(x_fit312_2, *popt312_2), label=r'$A1 = %.3f; \mu 1 = %.3f; \sigma 1 = %.3f; A2 = %.3f; \mu 2 = %.3f; \sigma 2 = %.3f; d = %.3f$' %(A1,mu1,sigma1,A2,mu2,sigma2,d))
...
with open('aula3_14.lab', 'r') as file:
    lines = file.readlines()
...
popt314_1, _ = curve_fit(gauss_sum, T_Piezo314, T_Foto314, p0=p0314)
x_fit314_1 = np.linspace(5, 7.5)  # Intervalo para o ajuste
A3 , mu3 , sigma3, A4, mu4, sigma4, d = popt314_1[0] , popt314_1[1], popt314_1[2] , popt314_1[3], popt314_1[4], popt314_1[5], popt314_1[6]
...
popt314_2, _ = curve_fit(gauss_sum, T_Piezo314, T_Foto314, p0=p0314_2)
x_fit314_2 = np.linspace(0, 1.8)  # Intervalo para o ajuste
A1 , mu1 , sigma1, A2, mu2, sigma2, d = popt314_2[0] , popt314_2[1], popt314_2[2] , popt314_2[3], popt314_2[4], popt314_2[5], popt314_2[6]
...
plt.plot(x_fit314_1, gauss_sum(x_fit314_1, *popt314_1), label=r'$A3 = %.3f; \mu 3 = %.3f; \sigma 3 = %.3f; A4 = %.3f; \mu 4 = %.3f; \sigma 4  = %.3f; d = %.3f$' %(A3,mu3,sigma3,A4,mu4,sigma4,d))
plt.plot(x_fit314_2, gauss_sum(x_fit314_2, *popt314_2), label=r'$A1 = %.3f; \mu 1 = %.3f; \sigma 1 = %.3f; A2 = %.3f; \mu 2 = %.3f; \sigma 2 = %.3f; d = %.3f$' %(A1,mu1,sigma1,A2,mu2,sigma2,d))
...
with open('aula3_16.lab', 'r') as file:
    lines = file.readlines()
...
popt316_1, _ = curve_fit(gauss, valores_selecionados_1, T_Foto316[(T_Piezo316 >= 0) & (T_Piezo316 <= 1.5)], p0=p0316_1)

p0316_2 = [T_Foto316.max(), mean316_2, std_dev316_2, 5]  # Estimativas iniciais para A, mu e sigma
popt316_2, _ = curve_fit(gauss, valores_selecionados_2, T_Foto316[(T_Piezo316 >= 6) & (T_Piezo316 <= 8)], p0=p0316_2)
...
plt.plot(x_fit316_1, gauss(x_fit316_1, *popt316_1), label=r'$A1 = %.3f; \mu 1 = %.3f; \sigma 1 = %.3f; d = %.3f$' %(popt316_1[0], popt316_1[1],popt316_1[2], popt316_1[3]))
plt.plot(x_fit316_2, gauss(x_fit316_2, *popt316_2), label=r'$A2 = %.3f; \mu 2 = %.3f; \sigma 2 = %.3f; d = %.3f$' %(popt316_2[0], popt316_2[1],popt316_2[2], popt316_2[3]))
...
with open('aula3_17.lab', 'r') as file:
    lines = file.readlines()
...
popt317_1, _ = curve_fit(gauss, valores_selecionados_1, T_Foto317[(T_Piezo317 >= 0) & (T_Piezo317 <= 2)], p0=p0317_1)

p0317_2 = [T_Foto317.max(), mean317_2, std_dev317_2, 5]  # Estimativas iniciais para A, mu e sigma
popt317_2, _ = curve_fit(gauss, valores_selecionados_2, T_Foto317[(T_Piezo317 >= 6) & (T_Piezo317 <= 8.5)], p0=p0317_2)
...
plt.plot(x_fit317_1, gauss(x_fit317_1, *popt317_1), label=r'$A1 = %.3f; \mu 1 = %.3f; \sigma 1 = %.3f; d = %.3f$' %(popt317_1[0], popt317_1[1],popt317_1[2], popt317_1[3]))
plt.plot(x_fit317_2, gauss(x_fit317_2, *popt317_2), label=r'$A2 = %.3f; \mu 2  = %.3f; \sigma 2 = %.3f; d = %.3f$' %(popt317_2[0], popt317_2[1],popt317_2[2], popt317_2[3]))
...
with open('aula3_18.lab', 'r') as file:
    lines = file.readlines()
...
popt318_1, _ = curve_fit(gauss, valores_selecionados_1, T_Foto318[(T_Piezo318 >= 0) & (T_Piezo318 <= 2)], p0=p0318_1)

p0318_2 = [T_Foto318.max(), mean318_2, std_dev318_2, 5]  # Estimativas iniciais para A, mu e sigma
popt318_2, _ = curve_fit(gauss, valores_selecionados_2, T_Foto318[(T_Piezo318 >= 6) & (T_Piezo318 <= 8.5)], p0=p0318_2)
...
plt.plot(x_fit318_1, gauss(x_fit318_1, *popt318_1), label=r'$A1 = %.3f; \mu 1 = %.3f; \sigma 1 = %.3f; d = %.3f$' %(popt318_1[0], popt318_1[1],popt318_1[2], popt318_1[3]))
plt.plot(x_fit318_2, gauss(x_fit318_2, *popt318_2), label=r'$A2 = %.3f; \mu 2 = %.3f; \sigma 2 = %.3f; d = %.3f$' %(popt318_2[0], popt318_2[1],popt318_2[2], popt318_2[3]))
...
with open('aula3_19.lab', 'r') as file:
    lines = file.readlines()
...
popt319_1, _ = curve_fit(gauss, valores_selecionados_1, T_Foto319[(T_Piezo319 >= 0) & (T_Piezo319 <= 2)], p0=p0319_1)

p0319_2 = [T_Foto319.max(), mean319_2, std_dev319_2, 5]  # Estimativas iniciais para A, mu e sigma
popt319_2, _ = curve_fit(gauss, valores_selecionados_2, T_Foto319[(T_Piezo319 >= 6) & (T_Piezo319 <= 8.5)], p0=p0319_2)
...
plt.plot(x_fit319_1, gauss(x_fit319_1, *popt319_1), label=r'$A1 = %.3f; \mu 1 = %.3f; \sigma 1 = %.3f; d = %.3f$' %(popt319_1[0], popt319_1[1],popt319_1[2], popt319_1[3]))
plt.plot(x_fit319_2, gauss(x_fit319_2, *popt319_2), label=r'$A2 = %.3f; \mu 2 = %.3f; \sigma 2 = %.3f; d = %.3f$' %(popt319_2[0], popt319_2[1],popt319_2[2], popt319_2[3]))
...
with open('aula3_20.lab', 'r') as file:
    lines = file.readlines()
...
popt320_1, _ = curve_fit(gauss, valores_selecionados_1, T_Foto320[(T_Piezo320 >= 0) & (T_Piezo320 <= 2)], p0=p0320_1)

p0320_2 = [T_Foto320.max(), mean320_2, std_dev320_2, 5]  # Estimativas iniciais para A, mu e sigma
popt320_2, _ = curve_fit(gauss, valores_selecionados_2, T_Foto320[(T_Piezo320 >= 6) & (T_Piezo320 <= 8.5)], p0=p0320_2)
...
plt.plot(x_fit320_1, gauss(x_fit320_1, *popt320_1), label=r'$A1 = %.3f; \mu 1 = %.3f; \sigma 1 = %.3f; d = %.3f$' %(popt320_1[0], popt320_1[1],popt320_1[2], popt320_1[3]))
plt.plot(x_fit320_2, gauss(x_fit320_2, *popt320_2), label=r'$A2 = %.3f; \mu 2 = %.3f; \sigma 2 = %.3f; d = %.3f$' %(popt320_2[0], popt320_2[1],popt320_2[2], popt320_2[3]))
...
with open('aula3_21.lab', 'r') as file:
    lines = file.readlines()
...
popt321_1, _ = curve_fit(gauss, valores_selecionados_1, T_Foto321[(T_Piezo321 >= 0) & (T_Piezo321 <= 2)], p0=p0321_1)

p0321_2 = [T_Foto321.max(), mean321_2, std_dev321_2, 5]  # Estimativas iniciais para A, mu e sigma
popt321_2, _ = curve_fit(gauss, valores_selecionados_2, T_Foto321[(T_Piezo321 >= 6) & (T_Piezo321 <= 8.5)], p0=p0321_2)
...
plt.plot(x_fit321_1, gauss(x_fit321_1, *popt321_1), label=r'$A1 = %.3f; \mu 1 = %.3f; \sigma 1 = %.3f; d = %.3f$' %(popt321_1[0], popt321_1[1],popt321_1[2], popt321_1[3]))
plt.plot(x_fit321_2, gauss(x_fit321_2, *popt321_2), label=r'$A2 = %.3f; \mu 2 = %.3f; \sigma 2 = %.3f; d = %.3f$' %(popt321_2[0], popt321_2[1],popt321_2[2], popt321_2[3]))
